...
$route['admin/users/change-shop-status-ajax'] = 'users/admin_change_shop_status_ajax';
$route['admin/users/shop'] = 'users/index_shop';
$route['admin/users/shop/(:num)'] = 'users/index_shop/$1';

$route['admin/users/shop/content'] = 'users/admin_shop_content';
$route['admin/users/shop/content/(:num)'] = 'users/admin_shop_content/$1';
 ...
 * MODULE COUPON
 */
$route['admin/voucher/check-code-availablity-ajax'] = 'voucher/check_code_availablity';
$route['admin/voucher/get-generate-coupons-ajax'] = "voucher/ajax_generate_coupons";
$route['admin/voucher/change-field'] = "voucher/admin_ajax_change_field";
$route['admin/voucher'] = "voucher/admin_index";
$route['admin/voucher/([0-9\-]+)'] = "voucher/admin_index/$1";
$route['admin/voucher/content'] = "voucher/admin_content";
$route['admin/voucher/content/([0-9\-]+)'] = "voucher/admin_content/$1";
$route['admin/voucher/delete'] = "voucher/admin_delete";
$route['admin/voucher/main'] = "voucher/admin_main";
...
// $route['admin/orders/fix'] = 'shops/orders/fix';
...
$route['admin/shops/export'] = 'shops/rows/admin_export_excel';
...
$route['dang-ky-ban-hang'] = "users/site_register_shop";
...
$route['apply-coupon-code-ajax'] = "voucher/apply_coupon_code_ajax";
$route['remove-coupon-code-ajax'] = "voucher/remove_coupon_code_ajax";
...
$route["quan-ly-bo-suu-tap/(:num)"] = "shops/collection/site_index/$1";
$route["quan-ly-bo-suu-tap"] = "shops/collection/site_index";
$route["them-bo-suu-tap/(:num)"] = "shops/collection/site_content/$1";
$route["them-bo-suu-tap"] = "shops/collection/site_content";
$route["xoa-bo-suu-tap"] = "shops/collection/site_delete";

$route["dang-san-pham/(:num)"] = "shops/rows/site_content/$1";
$route["dang-san-pham"] = "shops/rows/site_content";
$route["quan-ly-san-pham/(:num)"] = "shops/rows/site_index/$1";
$route["quan-ly-san-pham"] = "shops/rows/site_index";
$route["xoa-san-pham"] = "shops/rows/site_delete";
...
$route["don-dat-hang/(:num)"] = "shops/orders/site_history/$1";
$route["don-dat-hang"] = "shops/orders/site_history";

$route["don-hang-gioi-thieu/(:num)"] = "shops/orders/site_ref_history/$1";
$route["don-hang-gioi-thieu"] = "shops/orders/site_ref_history";
$route["xem-don-hang/(:num)"] = "shops/orders/site_details";
...
$route['products/search-ajax'] = 'shops/rows/ajax_search';
$route['users/search-ajax'] = 'users/ajax_search';
$route['users/json-tree-ajax'] = "users/ajax_json_tree";
...
$route["(:any)-(:num)"] = "pages/site_details/$1";