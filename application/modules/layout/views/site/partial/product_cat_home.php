...
<section>
    ...
    foreach ($data as $data_cat):
        ...
        if (isset($data_cat['items']) && !empty($data_cat['items'])):
            $data_src = get_image(get_module_path('shops') . $first_option['image'], get_module_path('shops') . 'no-image.png');
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
                    <div class="block-categories">
                        <div class="block-categories--image">
                            <img src="<?php echo $data_src?>" alt="" class="img-fluid">
                        </div>
                            ...
                            <div>
                                <div class="box-product-item">
                                    ...
                                    <div class="block-product--tag">
                                        <img src="<?php echo get_asset('img_path'); ?>label_sale.png" alt="" class="img-fluid">
                                    </div>
                                    <?php endif ?>
                                </div>
                            </div>
