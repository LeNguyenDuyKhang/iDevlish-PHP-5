                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="block-single-product--image">
                            ...
                            <?php $image_option = get_image(get_module_path('shops') . $first_option['image'], get_module_path('shops') . 'no-image.png'); ?>
                            ...
                            <div class="mr-10px">
                                <div class="single-product-image--slider">
                                    ...
                                    <?php foreach ($row['options'] as $value): $image_option = get_image(get_module_path('shops') . $first_option['image'], get_module_path('shops') . 'no-image.png'); ?>
                                    <div>
                                        <div class="single-product-slider-item">
                                ...
                                <?php if(isset($row['user_id']) && $row['user_id'] != 1): ?>
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="<?php echo base_url('shop/' . $row['shop_id']); ?>"><img src="<?php echo get_image('users' , $row['shop_logo'], 'no-image.png','68x68x1'); ?>" class="media-object" style="width: 68px; border-radius: 50px;"></a>
                                        </div>
